...
const routes: Routes = [
  ...
  },
  {
    ...
    children  : [
      ...
      {
        path      : 'admin',
        loadChildren:'./rcsa-admin-risk-manager/rcsa-admin-risk-manager.module#RcsaAdminRiskManagerModule',
        data      : {
          title   : 'Admin',
          viewId  : 'rcsa_admin'
        }
      ...
      {
        path      : 'rcsa-view/set-up-business-unit',
      ...
      {
        path      : 'remediations/remediation-summary-report',
      ...
      {
        path      : 'remediations/rm-assigned-outstanding-remediations',
      ...
      {
        path      : 'remediations/setup-remediation-unit',
        component : RcsaUnitRmSetUpRemediationComponent,
        data      : {
          title   : 'Unit Risk Manager Setup Remediations',
